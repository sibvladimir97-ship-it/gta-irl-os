...
OFFER_KEYWORDS = [
    ...
    "готов заплатить",
    # Монтаж и видео
    "монтаж", "видеомонтаж", "монтажёр", "монтажер",
    "нужен монтаж", "ищу монтажёра", "ищу монтажера",
    "youtube", "ютуб", "ютьюб", "reels", "рилс", "шортс", "shorts",
    "нужен видеограф", "ищу видеографа", "видеоролик", "видео ролик",
    "нарезка", "субтитры", "озвучка", "видеоредактор",
    "premiere", "after effects", "capcut", "davinci",
    "контент", "контент-мейкер", "#монтаж", "#видео",
    # Общие
    "#ищу",
]
