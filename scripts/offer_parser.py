...
# Хэштеги и фразы тех кто ПРЕДЛАГАЕТ услуги — фильтруем
EXCLUDE_KEYWORDS = [
    "#помогу", "#предлагаю", "#услуги", "#выполню", "#возьмусь",
    "#портфолио", "#опыт", "#резюме", "#ищуработу", "#ищу_работу",
    "предлагаю свои услуги", "готов выполнить", "возьмусь за",
    "мои услуги", "портфолио", "пишите мне", "обращайтесь ко мне",
...
def is_offer(text):
    ...
    # Сначала проверяем исключения — если есть #помогу и подобные, пропускаем
    for excl in EXCLUDE_KEYWORDS:
        if excl.lower() in text_lower:
            return False, []

    # Затем ищем ключевые слова заказчика
